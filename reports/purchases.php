...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  ...
  <script>
    $(document).ready(function() {
      ...
      // Prepare sales data for JS chart
      const salesData = <?php echo json_encode(array_map(function ($s) {
                          return [
                            'date' => $s['sale_date'],
                            'total' => (float)$s['total_revenue'] // Total revenue per row
                          ];
                        }, $sales)); ?>;
      ...
      function updateChart(range) {
        ...
        // Aggregate sales per hour (<1 day) or per day (>=1 day)
      ...
      // Initialize chart default to 7 days
      updateChart('7d');
